 ...
 */
public class ContactInfoAdapter extends RecyclerView.Adapter<ContactInfoAdapter.MyViewHolder> {
    ...
    public ContactInfoAdapter(Context context, List<CustomerModel> customerModelList) {
