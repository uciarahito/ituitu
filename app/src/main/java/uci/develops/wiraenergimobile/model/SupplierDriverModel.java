...
public class SupplierDriverModel {
    private int id;
    ...
    public SupplierDriverModel(int id, String decode, String supplier_decode, String name, String address, String phone, String mobile, String email, int priority, String created_at, String updated_at, String register_at, String created_by, String updated_by, int active, String detail, String deleted_at) {
        this.id = id;
        this.decode = decode;
