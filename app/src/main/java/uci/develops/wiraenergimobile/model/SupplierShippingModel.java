...
public class SupplierShippingModel {
    ...
    public SupplierShippingModel(int id, String decode, String supplier_decode, String codearea, String unitprice, String quantity, String note, int priority, String created_at, String updated_at, String register_at, String created_by, String updated_by, int active, String detail, String deleted_at) {
        this.id = id;
        this.decode = decode;
