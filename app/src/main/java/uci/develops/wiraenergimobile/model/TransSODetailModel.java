...
public class TransSODetailModel {
    private int id;
    ...
    public TransSODetailModel(int id, String so_decode, String barang_decode, String barang_name, String unit_decode, String unit_name, String so_qty, String do_qty, String qty, String price, String discount, String discount_amount, String total_price, String total_commission, String note, String do_date, int priority, String created_at, String updated_at, String register_at, String created_by, String updated_by, int active, int status, String detail, String deleted_at) {
        this.id = id;
