...
public class VerificationStatusActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(VerificationStatusActivity.this, ListCustomerActivity.class);
                    startActivity(intent);
                } else if (new SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "roles").equals("customer")) {
                    Intent intent = new Intent(VerificationStatusActivity.this, FormCustomerActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                        SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "user_id")));
        ...
        if (new SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(VerificationStatusActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(VerificationStatusActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(VerificationStatusActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(VerificationStatusActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }
                ...
                if (selectedItem.equals("Quotation")) {
                    ...
                    Intent intent = new Intent(VerificationStatusActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Invoice")) {
                    Intent intent = new Intent(VerificationStatusActivity.this, InvoiceActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Payment")) {
                    Intent intent = new Intent(VerificationStatusActivity.this, PaymentActivity.class);
                    startActivity(intent);
                }
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    Intent intent = new Intent(VerificationStatusActivity.this, HomeActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    if (new SharedPreferenceManager().getPreferences(VerificationStatusActivity.this, "roles").equals("customer")) {
                        Intent intent = new Intent(VerificationStatusActivity.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(VerificationStatusActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(VerificationStatusActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(VerificationStatusActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(VerificationStatusActivity.this, "roles", "");

        Intent intent = new Intent(VerificationStatusActivity.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
