...
public class FormRequestGoodReceived extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_request_good_received);
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "roles").equals("admin")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, ListCustomerActivity.class);
                    startActivity(intent);
                } else if (new SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "roles").equals("customer")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, FormCustomerActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "user_id")));
        ...
        if (new SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(FormRequestGoodReceived.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(FormRequestGoodReceived.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(FormRequestGoodReceived.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }

                //utk menu sales
                if (selectedItem.equals("Quotation")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, SalesQuotationAdminActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Sales Order [SO]")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, SalesOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Delivery Order [DO]")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, DeliveryOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Invoice")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, InvoiceActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Payment")) {
                    Intent intent = new Intent(FormRequestGoodReceived.this, PaymentActivity.class);
                    startActivity(intent);
                }
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    Intent intent = new Intent(FormRequestGoodReceived.this, HomeActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    if (new SharedPreferenceManager().getPreferences(FormRequestGoodReceived.this, "roles").equals("customer")) {
                        Intent intent = new Intent(FormRequestGoodReceived.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(FormRequestGoodReceived.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(FormRequestGoodReceived.this, "token", "");
        new SharedPreferenceManager().setPreferences(FormRequestGoodReceived.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(FormRequestGoodReceived.this, "roles", "");

        Intent intent = new Intent(FormRequestGoodReceived.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
