...
import uci.develops.wiraenergimobile.adapter.SalesOrderAdapter;
...
public class SalesOrderActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(SalesOrderActivity.this, ListCustomerActivity.class);
                    startActivity(intent);
                } else if (new SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "roles").equals("customer")) {
                    Intent intent = new Intent(SalesOrderActivity.this, FormCustomerActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                        SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "user_id")));
        ...
        if (new SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(SalesOrderActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(SalesOrderActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(SalesOrderActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(SalesOrderActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }

                //utk menu sales
                if (selectedItem.equals("Quotation")) {
                    Intent intent = new Intent(SalesOrderActivity.this, SalesQuotationAdminActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Sales Order [SO]")) {
                    Intent intent = new Intent(SalesOrderActivity.this, SalesOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Delivery Order [DO]")) {
                    Intent intent = new Intent(SalesOrderActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Invoice")) {
                    Intent intent = new Intent(SalesOrderActivity.this, InvoiceActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Payment")) {
                    Intent intent = new Intent(SalesOrderActivity.this, PaymentActivity.class);
                    startActivity(intent);
                }
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    Intent intent = new Intent(SalesOrderActivity.this, HomeActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    if (new SharedPreferenceManager().getPreferences(SalesOrderActivity.this, "roles").equals("customer")) {
                        Intent intent = new Intent(SalesOrderActivity.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(SalesOrderActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(SalesOrderActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(SalesOrderActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(SalesOrderActivity.this, "roles", "");

        Intent intent = new Intent(SalesOrderActivity.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
