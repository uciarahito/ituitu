...
public class GoodReceivedActivity extends AppCompatActivity implements View.OnClickListener {

    @BindView(R.id.button_add_good_receive)
    Button button_add_good_receive;
    @BindView(R.id.recycleListGoodReceive)
    RecyclerView recycleListGoodReceive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_good_received);
    ...
    private void initializeComponent() {
        button_add_good_receive.setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        if (v == button_add_good_receive) {
            Intent intent = new Intent(GoodReceivedActivity.this, FormRequestGoodReceived.class);
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(GoodReceivedActivity.this, ListCustomerActivity.class);
                    startActivity(intent);
                } else if (new SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "roles").equals("customer")) {
                    Intent intent = new Intent(GoodReceivedActivity.this, FormCustomerActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "token"), Integer.parseInt(new SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "user_id")));
        ...
        if (new SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(GoodReceivedActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(GoodReceivedActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(GoodReceivedActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(GoodReceivedActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }
                ...
                if (selectedItem.equals("Quotation")) {
                    ...
                    Intent intent = new Intent(GoodReceivedActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Invoice")) {
                    Intent intent = new Intent(GoodReceivedActivity.this, InvoiceActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Payment")) {
                    Intent intent = new Intent(GoodReceivedActivity.this, PaymentActivity.class);
                    startActivity(intent);
                }
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    if (new SharedPreferenceManager().getPreferences(GoodReceivedActivity.this, "roles").equals("customer")) {
                        Intent intent = new Intent(GoodReceivedActivity.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(GoodReceivedActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(GoodReceivedActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(GoodReceivedActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(GoodReceivedActivity.this, "roles", "");

        Intent intent = new Intent(GoodReceivedActivity.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
