...
public class FormSalesQuotationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(FormSalesQuotationActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(FormSalesQuotationActivity.this, ListCustomerActivity.class);
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                        SharedPreferenceManager().getPreferences(FormSalesQuotationActivity.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(FormSalesQuotationActivity.this, "user_id")));
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(FormSalesQuotationActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(FormSalesQuotationActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(FormSalesQuotationActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(FormSalesQuotationActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }
                ...
                if (selectedItem.equals("Quotation")) {
                    ...
                    Intent intent = new Intent(FormSalesQuotationActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Invoice")) {
                    Intent intent = new Intent(FormSalesQuotationActivity.this, InvoiceActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Payment")) {
                    Intent intent = new Intent(FormSalesQuotationActivity.this, PaymentActivity.class);
                    startActivity(intent);
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(FormSalesQuotationActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(FormSalesQuotationActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(FormSalesQuotationActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(FormSalesQuotationActivity.this, "roles", "");

        Intent intent = new Intent(FormSalesQuotationActivity.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
