...
public class PaymentActivity extends AppCompatActivity {
    ...
    @BindView(R.id.recycleListPayment) RecyclerView recycleListPayment;
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(PaymentActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(PaymentActivity.this, ListCustomerActivity.class);
                    startActivity(intent);
                } else if (new SharedPreferenceManager().getPreferences(PaymentActivity.this, "roles").equals("customer")) {
                    Intent intent = new Intent(PaymentActivity.this, FormCustomerActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                        SharedPreferenceManager().getPreferences(PaymentActivity.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(PaymentActivity.this, "user_id")));
        ...
        if (new SharedPreferenceManager().getPreferences(PaymentActivity.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(PaymentActivity.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(PaymentActivity.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(PaymentActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(PaymentActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(PaymentActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(PaymentActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }

                //utk menu sales
                if (selectedItem.equals("Quotation")) {
                    Intent intent = new Intent(PaymentActivity.this, SalesQuotationAdminActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Sales Order [SO]")) {
                    Intent intent = new Intent(PaymentActivity.this, SalesOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Delivery Order [DO]")) {
                    Intent intent = new Intent(PaymentActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    if (new SharedPreferenceManager().getPreferences(PaymentActivity.this, "roles").equals("customer")) {
                        Intent intent = new Intent(PaymentActivity.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(PaymentActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(PaymentActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(PaymentActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(PaymentActivity.this, "roles", "");
