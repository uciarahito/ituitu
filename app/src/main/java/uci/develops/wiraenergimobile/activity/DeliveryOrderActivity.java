...
public class DeliveryOrderActivity extends AppCompatActivity {
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(DeliveryOrderActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(DeliveryOrderActivity.this, ListCustomerActivity.class);
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                SharedPreferenceManager().getPreferences(DeliveryOrderActivity.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(DeliveryOrderActivity.this, "user_id")));
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(DeliveryOrderActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(DeliveryOrderActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(DeliveryOrderActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(DeliveryOrderActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }
                ...
                if (selectedItem.equals("Quotation")) {
                    ...
                    Intent intent = new Intent(DeliveryOrderActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Invoice")) {
                    Intent intent = new Intent(DeliveryOrderActivity.this, InvoiceActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Payment")) {
                    Intent intent = new Intent(DeliveryOrderActivity.this, PaymentActivity.class);
                    startActivity(intent);
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(DeliveryOrderActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(DeliveryOrderActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(DeliveryOrderActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(DeliveryOrderActivity.this, "roles", "");

        Intent intent = new Intent(DeliveryOrderActivity.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
