...
public class WaitingApprovalActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(WaitingApprovalActivity.this, ListCustomerActivity.class);
                    startActivity(intent);
                } else if (new SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "roles").equals("customer")) {
                    Intent intent = new Intent(WaitingApprovalActivity.this, FormCustomerActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                        SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "user_id")));
        ...
        if (new SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(WaitingApprovalActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(WaitingApprovalActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(WaitingApprovalActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(WaitingApprovalActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }
                ...
                if (selectedItem.equals("Quotation")) {
                    ...
                    Intent intent = new Intent(WaitingApprovalActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Invoice")) {
                    Intent intent = new Intent(WaitingApprovalActivity.this, InvoiceActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Payment")) {
                    Intent intent = new Intent(WaitingApprovalActivity.this, PaymentActivity.class);
                    startActivity(intent);
                }
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    Intent intent = new Intent(WaitingApprovalActivity.this, HomeActivity.class);
                    startActivity(intent);
                    finish();
                    ...
                    if (new SharedPreferenceManager().getPreferences(WaitingApprovalActivity.this, "roles").equals("customer")) {
                        Intent intent = new Intent(WaitingApprovalActivity.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(WaitingApprovalActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(WaitingApprovalActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(WaitingApprovalActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(WaitingApprovalActivity.this, "roles", "");
