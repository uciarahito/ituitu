...
import uci.develops.wiraenergimobile.adapter.InvoiceAdapter;
...
public class InvoiceActivity extends AppCompatActivity {
    @BindView(R.id.recycleListInvoice) RecyclerView recycleListInvoice;
    ...
    public void navDrawer() {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(InvoiceActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(InvoiceActivity.this, ListCustomerActivity.class);
                    startActivity(intent);
                } else if (new SharedPreferenceManager().getPreferences(InvoiceActivity.this, "roles").equals("customer")) {
                    Intent intent = new Intent(InvoiceActivity.this, FormCustomerActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                        SharedPreferenceManager().getPreferences(InvoiceActivity.this, "token"),
                Integer.parseInt(new SharedPreferenceManager().getPreferences(InvoiceActivity.this, "user_id")));
        ...
        if (new SharedPreferenceManager().getPreferences(InvoiceActivity.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(InvoiceActivity.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(InvoiceActivity.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
    ...
    private void initItems() {
        items = ExpandableListDataSource.getArrayTitle(InvoiceActivity.this);
    }
    ...
    private void addDrawerItems() {
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(InvoiceActivity.this, "" + selectedItem, Toast.LENGTH_SHORT).show();
                /*
                ...
                if (selectedItem.equals("Purchase Order [PO]")) {
                    ...
                    Intent intent = new Intent(InvoiceActivity.this, PurchaseOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Good Received [GR]")) {
                    Intent intent = new Intent(InvoiceActivity.this, GoodReceivedActivity.class);
                    startActivity(intent);
                }

                //utk menu sales
                if (selectedItem.equals("Quotation")) {
                    Intent intent = new Intent(InvoiceActivity.this, SalesQuotationAdminActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Sales Order [SO]")) {
                    Intent intent = new Intent(InvoiceActivity.this, SalesOrderActivity.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Delivery Order [DO]")) {
                    Intent intent = new Intent(InvoiceActivity.this, DeliveryOrderActivity.class);
                    startActivity(intent);
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    if (new SharedPreferenceManager().getPreferences(InvoiceActivity.this, "roles").equals("customer")) {
                        Intent intent = new Intent(InvoiceActivity.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
    ...
    private void logout() {
        new SharedPreferenceManager().setPreferences(InvoiceActivity.this, "is_login", "");
        new SharedPreferenceManager().setPreferences(InvoiceActivity.this, "token", "");
        new SharedPreferenceManager().setPreferences(InvoiceActivity.this, "customer_decode", "");
        new SharedPreferenceManager().setPreferences(InvoiceActivity.this, "roles", "");
