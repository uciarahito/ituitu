...
public class PurchaseOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new SharedPreferenceManager().getPreferences(PurchaseOrderActivity.this, "roles").equals("admin")) {
                    Intent intent = new Intent(PurchaseOrderActivity.this, ListCustomerActivity.class);
        ...
        Call<UserResponse> userResponseCall = RestClient.getRestClient().getUser("Bearer " + new
                SharedPreferenceManager().getPreferences(PurchaseOrderActivity.this, "token"), Integer.parseInt(new SharedPreferenceManager().getPreferences(PurchaseOrderActivity.this, "user_id")));
