...
public class FormRequestQuotationActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_request_quotation2);
    ...
    public void onClick(View v) {
        Call<CustomerResponse> customerResponseCall = RestClient.getRestClient().getCustomer("Bearer "+new SharedPreferenceManager().getPreferences(FormRequestQuotationActivity2.this, "token"),
                new SharedPreferenceManager().getPreferences(FormRequestQuotationActivity2.this, "customer_decode"));
        ...
        if (v == button_submit) {
            Intent intent = new Intent(FormRequestQuotationActivity2.this, HomeActivity.class);
    ...
    private void showDialogShippingAddress() {
        ...
        final Dialog dialogShippingAddress = new Dialog(FormRequestQuotationActivity2.this);
        ...
        Call<ListCustomerAddressResponse> customerAddressResponseCall = RestClient.getRestClient().getCustomerAddress("Bearer "
                + new SharedPreferenceManager().getPreferences(FormRequestQuotationActivity2.this, "token"),
                new SharedPreferenceManager().getPreferences(FormRequestQuotationActivity2.this, "customer_decode"));
            ...
            public void onResponse(Call<ListCustomerAddressResponse> call, Response<ListCustomerAddressResponse> response) {
                if(response.isSuccessful()){
                    if(response.body().getData().size() > 0) {
                        ...
                        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(FormRequestQuotationActivity2.this,
                        ...
                        spinner_shipping_address_name.setOnItemSelectedListener(new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                Toast.makeText(FormRequestQuotationActivity2.this, ""+check_List[position], Toast.LENGTH_SHORT).show();
    ...
    private void showDialogCompanyAddress() {
        final Dialog dialogCompanyAddress = new Dialog(FormRequestQuotationActivity2.this);
    ...
    private void showDialogNewItemQuotation() {
        final Dialog dialogItemQuotation = new Dialog(FormRequestQuotationActivity2.this);
        dialogItemQuotation.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialogItemQuotation.setContentView(R.layout.custom_dialog_form_item_quotation);
        ...
        listItem.add("Liter");
        listItem.add("Barrel");
        ArrayAdapter<String> listAdapter = new ArrayAdapter<String>(FormRequestQuotationActivity2.this,
        ...
        listUnit.add("Solar");
        ArrayAdapter<String> unitAdapter = new ArrayAdapter<String>(FormRequestQuotationActivity2.this,
        ...
        // date picker dialog
        datePickerDialog = new DatePickerDialog(FormRequestQuotationActivity2.this, new DatePickerDialog.OnDateSetListener() {
            @Override
