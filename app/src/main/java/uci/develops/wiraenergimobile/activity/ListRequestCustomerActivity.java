...
public class ListRequestCustomerActivity extends AppCompatActivity {
    ...
    public void navDrawer(){
        ...
        if (new SharedPreferenceManager().getPreferences(ListRequestCustomerActivity.this, "roles").equals("admin")) {
            ...
            rootMenu.add("Sales");
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(ListRequestCustomerActivity.this, "roles").equals("")) {
            rootMenu.add("Logout");
        } else if (new SharedPreferenceManager().getPreferences(ListRequestCustomerActivity.this, "roles").equals("expedition")) {
            rootMenu.add("Dashboard");
            rootMenu.add("Profile");
        ...
        mExpandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (selected_item.equals("Logout")) {
                    ...
                    if (new SharedPreferenceManager().getPreferences(ListRequestCustomerActivity.this, "roles").equals("customer")) {
                        Intent intent = new Intent(ListRequestCustomerActivity.this, FormCustomerActivity.class);
                        startActivity(intent);
                    }
                }
