 ...
 * Use the {@link FragmentNavSales#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentNavSales extends Fragment {

    private static final String KEY_MOVIE_TITLE = "key_title";

    public FragmentNavSales() {
     ...
     */
    public static FragmentNavSales newInstance(String movieTitle) {
        FragmentNavSales fragmentNavSales = new FragmentNavSales();
        Bundle args = new Bundle();
        args.putString(KEY_MOVIE_TITLE, movieTitle);
        fragmentNavSales.setArguments(args);

        return fragmentNavSales;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nav_sales, container, false);
    }
