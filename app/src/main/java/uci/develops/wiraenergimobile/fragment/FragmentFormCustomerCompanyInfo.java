...
public class FragmentFormCustomerCompanyInfo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Type typeOfProvince = new TypeToken<ArrayList<ProvinceModel>>(){}.getType();
        provinceModelList = gson.fromJson(provinceJson, typeOfProvince);
        Type typeOfCity = new TypeToken<ArrayList<CityModel>>(){}.getType();
    ...
    public void showSearchableSpinnerGroup(){
        ...
        recyclerViewSpinnerGroup.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerViewSpinnerGroup, new ClickListener() {
            @Override
